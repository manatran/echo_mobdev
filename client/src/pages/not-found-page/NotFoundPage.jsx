	...
	render() {
		return (
			<main className="error-page">
				<div>
					<section className="card" style={{padding: 16+'px',flexDirection:'column'}}>
						<p>Sorry, can't find this page right now! However, we have found a cool song you might like.</p>
					...
					<section className="card" style={{padding: 16+"px",textAlign: 'center'}}>
						<a href="/" className="button">Stop your shenanigans! Take me back to the homepage.</a>
					</section>
				</div>
			</main>
		)
